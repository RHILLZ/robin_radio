...
class ResponsiveUtils {
  ...
  static double getResponsivePadding(double width) {
    if (width < Breakpoints.small) {
      return 16.0; // Mobile: standard padding
    } else if (width < Breakpoints.medium) {
      return 24.0; // Tablet: more generous padding
    } else {
      return 32.0; // Desktop: maximum padding
    }
  }
  ...
  static double getFontScale(double width) {
    if (width < Breakpoints.small) {
      return 1.0; // Mobile: standard scale
    } else if (width < Breakpoints.medium) {
